...
using PulseNetwork.Controllers;
...
namespace PulseNetwork.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var applicationuser = new ApplicationUser { UserName = model.UserName, Email = model.Email, Picture = null, ExperiencePoints = 0, FullName = model.FullName };
